...
#
import pickle  # The process to converts any kind of python objects (list, dict, etc.) into byte streams (0s and 1s) is called pickling
pickle.dump(tfidf,open('vectorizer.pkl','wb'))   #save the tfidf object into a file named 'vectorizer.pkl' using binary mode ('wb').
pickle.dump(mnb,open(r'C:\Users\Pooja Joshi\Desktop\SVM\SpamHam\model.pkl','wb'))